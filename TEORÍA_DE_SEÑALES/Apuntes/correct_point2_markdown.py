...
for cell in data['cells']:
    if cell['cell_type'] == 'markdown' and any('## 5. Punto 2' in line for line in cell.get('source', [])):
        cell['source'] = [
            ...
            'Para cada valor de $\pi_1 \in \{0.1,0.3,0.5,0.7,0.9\}$ calculamos el umbral MAP y evaluamos las probabilidades de error de falso ingreso y omisión.\n',
            '\n',
...
if not updated:
    raise SystemExit('Markdown cell for Punto 2 not found.')

with path.open('w', encoding='utf-8') as f:
    json.dump(data, f, ensure_ascii=False, indent=2)
print('Updated Punto 2 markdown correctly.')
